...
func (s *Store[T]) FromRequest(rc fernet.RequestContext) error {
...
func (s *Store[T]) Write(rc fernet.RequestContext) error {
	cookie, err := s.Cookie()
	if err != nil {
		return err
	}
...
// changed.
func (s *Store[T]) WriteIfChanged(rc fernet.RequestContext) error {
